...
| --- | --- | --- |
| Codex Orchestration | Runs agents and sub-agents to complete complex tasks. Just describe the task and it will continue running in the background—it doesn't even need goal mode to keep working. | [`skills/codex-orchestration`](skills/codex-orchestration) |
